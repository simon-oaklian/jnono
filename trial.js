...
function moveQuestion(delta) {
  ...
  persistContinueInProgress();
  renderQuestion();
  quizSection?.scrollIntoView({ behavior: "instant", block: "start" });
}
...
(function initMobileTabBar() {
  ...
  function syncTabBar() {
    const views = {
      ...
      account: document.getElementById("memberViewPlaceholder"),
    };
    let active = "home";
  ...
  ["memberViewDashboard", "memberViewPractice", "memberViewProgress", "memberViewPlaceholder"].forEach((id) => {
